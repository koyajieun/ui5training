		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "training",
									"targetURL": "#sapsyncui5training-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapsyncui5training-display": {
								"semanticObject": "sapsyncui5training",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.sync.ui5training",
									"url": sap.ui.require.toUrl("sap/sync/ui5training")
								}
							}
						}
					}
